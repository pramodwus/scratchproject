               ...
               <ul class="sidebar-menu" data-widget="tree">
                  ...
                  <li class="active treeview menu-open">
                     ...
                     <ul class="treeview-menu">
                        <li><a href="Predict_Single_Recruit"><i class="fa fa-user"></i> Predict Single Recruit</a></li>
                        <li class="active" style="background:#4d4d4d !important;"><a href="Predict_Multiple_Recruit.html"><i class="fa fa-users"></i>  Predict Multiple Recruit</a></li>
                     </ul>
                  </li>
                  <li class=" ">
                     <a href="#">
         ...
         <div class="content-wrapper">
            ...
            <section class="content-header">
               <ol class="breadcrumb">
                  ...
                  <li class="active">Predict Multiple Recruit</li>
               </ol>
            </section>
            <!-- Main content -->
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              <div class="col-md-12 table table-wrapper-scroll-y my-custom-scrollbar">
                <table>
                  <thead>
                    <th>Recruit ID</th>
                    <th>Success Probability</th>
                    <th>Candidate Traits</th>
                    <th>Prediction </th>
                  </thead>
                  <tbody>
                    <tr>
                      <td><a href="#">A0002</a></td>
                      <td>63%</td>
                      <td>Good</td>
                      <td>Success </td>
                    </tr>
                    <tr>
                      <td><a href="#">A0003</a></td>
                      <td>58%</td>
                      <td>Excellent </td>
                      <td>Success </td>
                    </tr>
                    <tr>
                      <td><a href="#">A0004</a></td>
                      <td>73%</td>
                      <td>Good</td>
                      <td>Dropout  </td>
                    </tr>
                    <tr>
                      <td><a href="#">A0005</a></td>
                      <td>47%</td>
                      <td>Excellent </td>
                      <td>Success </td>
                    </tr>
                    <tr>
                      <td><a href="#">A0006</a></td>
                      <td>69%</td>
                      <td>Poor </td>
                      <td>Success </td>
                    </tr>
